...
public class ComplexDataImpl implements ComplexData {
    ...
    public ComplexDataImpl(ConcurrentHashMap<String, BaseSection> sectionMap, ConcurrentHashMap<String, LinkedList<String>> alreadySectionMap, Player player) {
    ...
    @Override
    public void setAlreadySectionMap(ConcurrentHashMap<String, LinkedList<String>> alreadySectionMap) {
        this.alreadySectionMap = alreadySectionMap;
    }
