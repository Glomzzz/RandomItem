...
public final class RandomItemCallable implements Callable<ItemStack> {
    ...
    public ItemStack call() {
        ...
        ConcurrentHashMap<String, LinkedList<String>> alreadySectionMap = new ConcurrentHashMap<>();
        ...
        if (this.itemData.getItemSection().contains("color")) {
            builder.color(Color.fromRGB(this.itemData.getItemSection().getInt("color")));
        }
