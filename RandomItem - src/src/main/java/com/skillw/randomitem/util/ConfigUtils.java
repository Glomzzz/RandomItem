...
public final class ConfigUtils {
    ...
    public static void sendGetItemMessage(CommandSender sender, String item, int amount) {
        send(sender, "item.get", item, String.valueOf(amount));
    }

    public static void sendGiveItemMessage(CommandSender sender, String player, String item, int amount) {
        send(sender, "item.give", player, item, String.valueOf(amount));
    }

    public static void sendDropItemMessage(CommandSender sender, String itemID, int amount, String world, String x, String y, String z) {
        send(sender, "item.drop", itemID, String.valueOf(amount), world, x, y, z);
    }
