                            ...
                            case "get":
                                if (args.length >= 2) {
                                    if (sender instanceof Player) {
                                        ...
                                        if (amountFormula != null) {
                                            itemManager.giveRandomItemRandomly(itemID, amountFormula, chanceFormula, isSame, player, null, pointData, true, isTip);
                                        } else {
                                            itemManager.giveRandomItem(player, itemID, null, pointData, true, isTip);
                                        }
                                    } else {
                                        sendOnlyPlayerMessage(sender);
                                    }
