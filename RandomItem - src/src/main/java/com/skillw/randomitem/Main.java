                        ...
                        switch (args[0]) {
                                        ...
                                        if (randomItem != null) {
                                            ...
                                            if (world != null) {
                                                ...
                                                if (x != 0 && y != 0 && z != 0) {
                                                    ...
                                                    getItemManager().dropRandomItemRandomly(itemID, location, amountFormula, chanceFormula, isSame, player, sender);
                                                }
                                            } else {
                            ...
                            case "give":
                                if (args.length >= 3) {
                                    ...
                                    Player player = Bukkit.getServer().getPlayer(name);
                                    if (player != null) {
                                        itemManager.giveRandomItem(player, itemID, sender, pointData);
                                        break;
                                    } else {
