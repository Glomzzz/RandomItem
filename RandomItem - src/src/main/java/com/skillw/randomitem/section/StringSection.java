...
public class StringSection extends BaseSection implements Weighable<SubString>, Debuggable {
    ...
    public BaseSection clone() {
        return new StringSection(this.getId(), this.getValueMap());
    }

    @Override
    public ConcurrentHashMap<String, SubString> getValueMap() {
    ...
    @Override
    public ConcurrentHashMap<String, BasicData<?>> getBasicDataMap() {
