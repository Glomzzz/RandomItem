...
import static com.skillw.randomitem.util.DebugUtils.debugConfigurationSection;
...
public final class RandomItemApiImpl implements RandomItemApi {
    ...
    public ItemData createItemData(ConfigurationSection section) {
        ...
        sendDebug("&d- &aUnbreakable: &6" + unbreakable);
        ...
        addRandomSectionsFromConfigSection(sectionMap, randomsSection);
        if (!sectionMap.isEmpty()) {
            sendDebug("&d- &aIndividual Random Sections:");
