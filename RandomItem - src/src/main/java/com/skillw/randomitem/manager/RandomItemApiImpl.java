...
public class RandomItemApiImpl implements RandomItemApi {
    ...
    @Override
    public RandomItem createRandomItem(String id, String display, String material, String data, List<String> lores, List<String> usedGlobalSections, ConfigurationSection nbtSection, ConcurrentHashMap<String, String> enchantmentMap, ConcurrentHashMap<String, BaseSection> sectionMap) {
        return new RandomItemImpl(id, display, material, data, lores, usedGlobalSections, nbtSection, enchantmentMap, sectionMap);
    }
