...
public interface ItemManager {
     ...
     */
    void giveRandomItem(Player player, String itemID, CommandSender sender, String pointData, boolean isDebug);

    void giveRandomItemRandomly(String itemID, String amountFormula, String chanceFormula, boolean isSame, Player player, CommandSender sender, String pointData, boolean isDebug);
     ...
     */
    void dropRandomItemRandomly(String itemID, Location location, String amountFormula, String chanceFormula, boolean isSame, Player player, CommandSender commandSender, boolean isDebug);
