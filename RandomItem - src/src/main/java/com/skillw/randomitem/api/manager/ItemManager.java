...
public interface ItemManager {
     ...
     */
    void giveRandomItem(Player player, String itemID, CommandSender sender, String pointData, boolean isDebug, boolean tip);

    void giveRandomItemRandomly(String itemID, String amountFormula, String chanceFormula, boolean isSame, Player player, CommandSender sender, String pointData, boolean isDebug, boolean tip);
     ...
     */
    void dropRandomItemRandomly(String itemID, Location location, String amountFormula, String chanceFormula, boolean isSame, Player player, CommandSender commandSender, boolean isDebug, boolean tip);
     ...
     * @return success
     */
    boolean createItemStackConfig(ItemStack itemStack, String itemKey, String path, boolean isDebug);
}
