...
public interface ItemManager {
    ...
    /**
     * To give the player a RandomItem.
     *
     ...
     * @param player        the player
     */
    void dropRandomItemRandomly(String itemID, Location location, String amountFormula, String chanceFormula, boolean isSame, Player player);
