...
public interface RandomItemApi {
    ...
    /**
     * To handle the point data
     *
     * @param pointData the point data
     * @param data      bean
     */
    void handlePointData(String pointData, ComplexData data);
     ...
     */
    RandomItem createRandomItem(ConfigurationSection section, boolean isDebug);
     ...
     */
    ItemData createItemData(ConfigurationSection section, boolean isDebug);
