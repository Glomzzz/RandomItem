...
public interface RandomItemApi {
     ...
     */
    RandomItem createRandomItem(String id, String display, String material, String data, List<String> lores, List<String> usedGlobalSections, ConfigurationSection nbtSection, ConcurrentHashMap<String, String> enchantmentMap, ConcurrentHashMap<String, BaseSection> sectionMap);
