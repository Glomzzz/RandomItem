...
public interface ComplexData {
     ...
     */
    Set<String> getDebugMessages();

    /**
     * To set the debug messages
     *
     * @param debugMessages the debug messages
     */
    void setDebugMessages(Set<String> debugMessages);

    /**
     * To add the debug message
     *
     * @param debugMessage the debug message
     */
    void addDebugMessages(String debugMessage);

    /**
     * To send all of the debug messages
     */
    ...
    /**
     * To get the map of BaseSection's id and the result of the calling of it
     *
     * @return the map of BaseSection's id and the result of the calling of it
     */
     ...
     */
    void setAlreadySectionMap(ConcurrentHashMap<String, String> alreadySectionMap);
