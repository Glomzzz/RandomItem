...
public interface ComplexData {
    ...
    void setDebugReplacingMessages(Set<String> messages);

    /**
     * To add the debug replacing message
     *
     * @param message the debug replacing message
     */
    void addDebugReplacingMessages(String message);
